/home/mschoenebeck/dev/leap/build/bin/nodeos --config-dir ./config --data-dir ./data --logconf ./logging.json --genesis-json ./genesis.json  >> "./chain.log" 2>&1 & echo $! > "./eosd.pid"
